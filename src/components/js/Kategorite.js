  ...
  return (
    <div className="mt-5 kategorite">
      <ul className="d-flex" style={{ listStyleType: 'none', justifyContent: 'center' }}>
        <li><Link to="/Feed" style={{ textDecoration: 'none', color: 'grey' }}>Të Gjitha</Link></li>
        <li><Link to={`${location.pathname}/Romance`} style={{ textDecoration: 'none', color: 'grey' }}>Romance</Link></li>
        <li><Link to={`/Zhanret/Drame`} style={{ textDecoration: 'none', color: 'grey' }}>Drame</Link></li>
        <li><Link to={`${location.pathname}/Fantazi`} style={{ textDecoration: 'none', color: 'grey' }}>Fantazi</Link></li>
        <li><Link to={`${location.pathname}/Krim`} style={{ textDecoration: 'none', color: 'grey' }}>Krim</Link></li>
        <li><Link to={`${location.pathname}/Bestseller`} style={{ textDecoration: 'none', color: 'grey' }}>Bestseller</Link></li>
        <li><Link to={`${location.pathname}/Klasike`} style={{ textDecoration: 'none', color: 'grey' }}>Klasikë</Link></li>
      </ul>
    </div>
  );
}
